...
const LEVEL_CONFIGS: LevelConfig[] = [
  ...
  { id: 6, name: 'Longer Arrows', difficulty: 'MEDIUM', rows: 5, cols: 5, seed: 2063, maxLength: 3, walls: 1 },
  { id: 7, name: 'Crossroads', difficulty: 'MEDIUM', rows: 5, cols: 6, seed: 2069, maxLength: 3, walls: 1 },
